...
export class CategoryDishController {
  protected service: categoryDishService;
  constructor() {
    this.service = new categoryDishService();
  }
  async getFilter(
    req: Request,
    res: Response,
    ...
    try {
      const filter: ICategoryDishFilter = req.query;
  ...
  async create(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const model: CategoryDishDTO = req.body;
